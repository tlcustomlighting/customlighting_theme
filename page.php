<?php
    get_header(); ?>
     <div class="row" style="padding-bottom:10px;border-bottom:2px solid lightgrey;">
         <div class="col-md-6">
                ...
                <?php
                    ...
                    switch($pageID){
                        ...
                        case 21:
                            ...
                            break;
                        case 23:
                            $images = get_posts(array('post_type' => 'attachment', 'post_mime_type'=>'image', 'numberposts' => -1, 'category_name'=>'sconces',
                            'tag'=>$results,
                            'tag_slug__in'=>$results));
                            $pageCode = 'S';
                            break;
                        case 19:
                            ...
                            break;
                        case 28:
                            $images = get_posts(array('post_type' => 'attachment', 'post_mime_type'=>'image', 'numberposts' => -1, 'category_name'=>'ceiling-mounts',
                            'tag'=>$results,
                            'tag_slug__in'=>$results));
                            $pageCode = 'C';
                    }
